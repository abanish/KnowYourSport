...
public class Questions2 extends Activity {
	...
	private static final String DB_NAME="cricketdb";
	MediaPlayer mp;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		Cursor c = Questions2.getQuestion(q);
		if (c.moveToFirst()) {
	...
	public void answer(View v) {
	    ...
	    mp.start();
			Intent i = new Intent(Questions2.this, Answer2.class);
 ...
 /*
	...
	public void onBackPressed() {
		...
		dbOpenHelper.close();
			...
			Intent i = new Intent(Questions2.this, Buttons2.class);
